...
begin
  for u in
    select * from (values
      ...
      ('77777777-7777-7777-7777-777777777777'::uuid, 'dummy-student6@example.com')
    ) as t(id, email)
  loop
...
values
  ...
  ('66666666-6666-6666-6666-666666666666', 'student', '더미학생오', '10105',
   '99999999-9999-9999-9999-999999999999'),
  ('77777777-7777-7777-7777-777777777777', 'student', '더미학생육', '10106',
   '99999999-9999-9999-9999-999999999999');
...
-- 명단: 학생1(동의O)·학생2(동의X)·학생4(동의O)·학생5(동의O)·학생6(동의O)는 멤버, 학생3은 비멤버(동의O)
-- 테스트 할당: M0 = 학생1(QR)/학생4(BLE)/학생5(PIN), M1 수동 = 학생6 (스위트 간 순서 의존 방지)
...
values
  ...
  ('77777777-7777-7777-7777-777777777777', 'v1', '11111111-1111-1111-1111-111111111111');
